...
<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Event Seat Zone</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo site_url()?>/EventVenue">Venue Event</a></li>
                        <li class="breadcrumb-item active">Event Seat Zone</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table" id="example">	
						...
						<tbody>
							<?php foreach ($seat_list as $key){ ?>
							<tr>
							<td><?php echo $key->idSeat ; ?></td>
							<td><?php echo $key->seatZone ; ?></td>
							<td><?php echo $key->Capacity ; ?></td>
							<td>
								<a href="javascript:void(0);" data-id="<?php echo $key->idSeat ; ?>" data-seat="<?php echo $key->seatZone ; ?>" data-cap="<?php echo $key->Capacity ; ?>" data-toggle="modal" data-target="#edit-data">
                            		<button  data-toggle="modal" data-target="#ubah-data" class="btn btn-secondary"><span class="fa fa-edit"></span></button></a>
								<a href="<?php echo base_url("index.php/EventSeat/deleteData/".$idVenue."/".$key->idSeat) ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this data permanently?'); "><span class="fa fa-trash"></span></a>
							</td>
							</tr>
							<?php } ?>
						</tbody>
	...
	<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="tambah-data" class="modal fade-in">
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <?php echo form_open('EventSeat/create/'.$idVenue); ?>
		            <div class="modal-body">
		            	<div class="container-fluid">
		                    <div class="form-group">
		                        <label class="col-lg-12 col-sm-12 control-label">Seat Zone Name</label>
		                        <div class="col-lg-12">
		                            <input type="text" class="form-control" name="seat" placeholder="Input Seat Zone Name" required>
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="col-lg-2 col-sm-2 control-label">Capacity</label>
		                        <div class="col-lg-12">
		                        	<textarea class="form-control" name="cap" placeholder="Input The Capacity" required></textarea>
		                        </div>
		                    </div>
		                    <div class="form-group">
    						<input type="hidden" class="form-control" name="venue" value="<?php echo $idVenue ?>">
  							</div>
		                </div>
		            </div>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            <div class="modal-header">
	             ...
	             <?php echo form_open('EventSeat/update/'.$idVenue); ?>
		            <div class="modal-body">
		                    <div class="form-group">
		                        <label class="col-lg-12 col-sm-12 control-label">Seat Zone Name</label>
		                        <div class="col-lg-12">
		                        	<input type="hidden" id="id" name="id">
		                            <input type="text" class="form-control" id="seat" name="seat" placeholder="Input Seat Zone Name" required>
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="col-lg-2 col-sm-2 control-label">Capacity</label>
		                        <div class="col-lg-12">
		                        	<textarea class="form-control" id="cap" name="cap" placeholder="Input The Capacity" required></textarea>
		                        </div>
		                    </div>
		                </div>
		                <div class="modal-footer">
